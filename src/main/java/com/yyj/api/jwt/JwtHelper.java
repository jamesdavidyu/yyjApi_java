...
public class JwtHelper {
    ...
    public JwtHelper(
            ...
            @Value("${com.yyj.api.refreshTokenExpirationDays}") int refreshTokenExpirationDays,
            @Value("${com.yyj.api.accessTokenExpirationMinutes}") int accessTokenExpirationMinutes
            ) {
    ...
    public String generateAccessToken(Youser user) {
        return JWT.create()
                .withIssuer(issuer)
    ...
    public String generateRefreshToken(Youser user, RefreshToken refreshToken) {
        return JWT.create()
                .withIssuer(issuer)
                .withSubject(user.getId())
